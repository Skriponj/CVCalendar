...
public final class CVCalendarViewAnimator {
    ...
    public var selectWithRoundShape = false
...
extension CVCalendarViewAnimator {
    public func animateSelectionOnDayView(_ dayView: DayView) {
        ...
        var selectionType = calendarView.shouldSelectRange ? CVSelectionType.range(.changed) : CVSelectionType.single
        if selectWithRoundShape == true {
            selectionType = CVSelectionType.single
        }
